...
- S3_POST_SCREEN — after screening: the client asks for a meet-and-greet, a live video
  call, insists on visiting the house, or asks any other question. Answer using the FAQ
  section below — it covers meet-and-greets (including the location/link), house visits,
